    ...
    public void onRender(Event3D e) {
        if (this.isToggled()) {
            ...
            if (landingPosition != null && landingPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                Gui.drawRect(-8.25f, -8.25f, 8.25f, 8.25f, 0x99ffffff);
            }
            GL11.glPopMatrix();
            if (landingPosition != null && landingPosition.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY) {
               ...
               // drawOutlineForEntity(null, landingPosition.entityHit.getEntityBoundingBox().expand(0.035, 0.0, 0.035).offset(0.0, 0.1, 0.0), 1.0f, 1f, 1.0f, 1.0f, 255);
